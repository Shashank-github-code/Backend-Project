...
const registerUser = asyncHandler( async (req,res)=>{
    ...
    //instead of writting if for all fields we can use .some method
    if (
    ...
    const existedUser = User.findOne({   //$or takes an array of object to apply any function like .findOne so if any field matches either of the two 
        $or:[{ username }, { email }]
    })
